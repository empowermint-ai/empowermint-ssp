...
export default function ExamDatesForm({
  ...
  // The native date input can hand back a value the learner never
  // deliberately confirmed - some mobile browsers pre-highlight the min
  // date when today is disabled and commit it on a stray tap. Staging the
  // pick here and requiring an explicit confirm tap (below) ensures an exam
  // date is only ever saved when the learner actually chooses to add it.
